...
func (c *nvcConn) NamedValueCheck(nv *driver.NamedValue) error {
...
func TestNamedValueChecker(t *testing.T) {
	...
	o1 := ""
	_, err = db.ExecContext(ctx, "INSERT|keys|dec1=?A,str1=?,out1=?O1,array1=?", Named("A", decimal{123}), "hello", Named("O1", Out{Value: &o1}), []int64{42, 128, 707}, doNotInclude{})
	if err != nil {
