...
// ErrOmitArgument may be returned from NamedValueChecker to instruct the
...
// SQL query arguments.
var ErrOmitArgument = errors.New("driver: omit argument from query")
...
// Lastly ColumnConverter is checked for if a Stmt is available.
//
// If ErrOmitArgument is returned, the NamedValue will not be included in
...
type NamedValueChecker interface {
	...
	NamedValueCheck(*NamedValue) error
}
